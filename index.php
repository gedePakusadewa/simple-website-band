...
<html lang="en">
    <head>
        <title>ColdPlay Official Website</title>
        <meta charset="UTF-8" />
...
<body>
    ...
    <!--pakek java script, cari aja dibawah fungsinya-->
    <!-- Automatic Slideshow Images -->
    <div class="mySlides w3-display-container w3-center">
        <img src="img/band1.jpg" style="width:100%" />
    ...
    <div class="mySlides w3-display-container w3-center">
        <img src="img/band2.jpg" style="width:100%">
        <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
        <h3>New York</h3>
    ...
    <div class="mySlides w3-display-container w3-center">
        <img src="img/band3.jpg" style="width:100%">
        <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
        <h3>Chicago</h3>
        <p><b>Thank you, Chicago - A night we won't forget.</b></p>    
        </div>
    </div>  <!-- akhir Automatic Slideshow Images -->

    <!-- The Band Section -->
    <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="band">
        <h2 class="w3-wide">COLD PLAY</h2>
        ...
        <div class="w3-row w3-padding-32">
            <div class="w3-third">
                <p>Name</p>
                <img src="img/personil1.jpg" class="w3-round w3-margin-bottom" alt="Random Name" style="width:60%">
            </div>
            <div class="w3-third">
                <p>Name</p>
                <img src="img/personil2.jpg" class="w3-round w3-margin-bottom" alt="Random Name" style="width:60%">
            </div>
            <div class="w3-third">
                <p>Name</p>
                <img src="img/personil3.jpg" class="w3-round w3-margin-bottom" alt="Random Name" style="width:60%">
            </div>
        </div>

    </div><!-- akhir The Band Section -->
                            ...
                            "<div class=\"w3-third w3-margin-bottom\">
                                ...
                                <div class=\"w3-container w3-white\">
                                    ...
                                    <button class=\"w3-button w3-black w3-margin-bottom\"
                                        onclick=\"document.getElementById('ticketModal').style.display=
